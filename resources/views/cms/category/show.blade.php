  ...
  <div class="card card-outline card-shift" style="border-top:3px solid var(--glow-pink);">
    ...
    <div class="card-header">
      <div class="d-flex align-items-center" style="gap:10px;">
        ...
        <div>
          <h3 class="card-title mb-0" style="font-weight:700;">Category Details</h3>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="glow-info-box mb-4">
        <div class="glow-row">
          <span class="glow-label">Category Name:</span>
          <span class="glow-value">{{ $categories->category_name }}</span>
        </div>

        <div class="glow-row">
          <span class="glow-label">Image Path:</span>
          <code class="path-code">{{ $categories->image_path ?? 'No image' }}</code>
        </div>
      </div>
    ...
    <div class="card-footer">
      <a href="{{ route('cms.categories.index') }}" class="btn btn-light"

  ...
  <div class="card card-outline card-shift" style="border-top:3px solid var(--glow-pink);">
    <div class="card-header">
      <div class="d-flex flex-wrap justify-content-between align-items-center">
        <div>
          <h3 class="card-title mb-0">Trashed Carts</h3>
        </div>
        ...
        <div class="d-flex align-items-center" style="gap:10px;">
          ...
          <a href="{{ route('cms.carts.index') }}" class="btn btn-glow-pink btn-sm">
            <i class="fas fa-arrow-left"></i> Back
          </a>

          <a href="{{ route('cms.carts_forceAll') }}"
      ...
      <div class="table-responsive">
        <table class="table table-hover table-striped mb-0">
          ...
          <tbody id="cartTable">
              ...
              <tr>
                ...
                <td class="text-center">
                  <span class="date-badge">
                    {{ $cart->deleted_at ? $cart->deleted_at->format('Y-m-d') : '-' }}
                  </span>
                </td>

                <td class="text-center">
                  <div class="actions-group">
                    <a href="{{ route('cms.carts.show', $cart->id) }}"
                       class="action-btn action-show"
                       data-toggle="tooltip" title="Show">
                      <i class="fas fa-eye"></i>
                    </a>

                    <a href="{{ route('cms.carts_restore', $cart->id) }}"
            ...
            @empty
              <tr>
                <td colspan="5" class="text-center text-muted p-4">No trashed carts found</td>
              </tr>
            @endforelse
          </tbody>
        </table>
...
<script>
    ...
    function performForceDelete(id, reference){
        confirmDestroy('/cms/admin/carts_force/' + id, reference);
    }
</script>
@endsection

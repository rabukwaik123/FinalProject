  ...
  <div class="card card-outline card-shift" style="border-top:3px solid var(--glow-pink);">
    <div class="card-header">
      <div class="d-flex align-items-center" style="gap:10px;">
        ...
        <div>
          <h3 class="card-title mb-0" style="font-weight:700;">Add New brand</h3>
    ...
    <form method="POST" action="{{ route('cms.brands.store') }}" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="hint-box mb-3">
          <strong>Tip:</strong> Your main brands are <b>Rimmel London</b>, <b>NOTE</b>, <b>Petite Maison</b> , <b>Topface</b>.
          You can add new brands if needed (e.g. Perfume, Body care…).
        </div>

        <div class="form-group">
          <label for="brand_name" style="font-weight:600;">brand Name</label>
          <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name') }}" class="form-control" placeholder="e.g. Perfume" maxlength="50"autofocus>

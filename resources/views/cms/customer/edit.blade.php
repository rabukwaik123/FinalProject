      ...
      <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select id="birth_month" name="birth_month" class="form-control">
                ...
                @foreach(['January','February','March','April','May','June','July','August','September','October','November','December'] as $month)
                  <option value="{{ $month }}"
                    {{ ($customer->user->birth_month ?? '') == $month ? 'selected' : '' }}>
                    {{ $month }}
                  </option>
                @endforeach
              </select>
        ...
        <div class="form-group mt-3">
          ...
          <select id="status" name="status" class="form-control">
            <option value="active"   {{ ($customer->user->status ?? '') == 'active'   ? 'selected' : '' }}>Active</option>
            <option value="inactive" {{ ($customer->user->status ?? '') == 'inactive' ? 'selected' : '' }}>Inactive</option>
          </select>
        </div>

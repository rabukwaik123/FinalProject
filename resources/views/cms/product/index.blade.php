      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center" style="gap:10px;">
          <div class="input-group input-group-sm" style="width: 240px;">
            <input id="catSearch" type="text" class="form-control" placeholder="Search product...">
            <div class="input-group-append">
              <span class="input-group-text"><i class="fas fa-search"></i></span>
            </div>
          </div>

          <a href="{{ route('cms.products.create') }}" class="btn btn-glow-pink btn-sm">
        ...
        <table class="table table-hover table-striped mb-0">
          ...
          <tbody id="catTable">
            ...
            <tr>
                ...
                <td>
                  <span class="cat-name">{{ $product->product_name }}</span>
                </td>
                ...
                <td class="text-center">
                  <div class="actions-group">
                    ...
                    <a href="{{ route('cms.products.edit', $product->id) }}" class="action-btn action-edit" data-toggle="tooltip" title="Edit">
                      <i class="fas fa-pen"></i>
                    </a>

                    <form action="{{ route('cms.products.destroy', $product) }}" method="POST" class="m-0">
                      @csrf
                      @method('DELETE')
                      <button type="button"
                              onclick="performDestroy({{ $product->id }}, this)"
